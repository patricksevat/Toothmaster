...
//   .service('sendAndReceiveService', ['statusService', 'emergencyService', '$window', 'logService', '$rootScope', 'buttonService', 'crcService', '$ionicPopup', 'shareSettings', '$interval', '$timeout', function (statusService, emergencyService, $window, logService, $rootScope, buttonService, crcService, $ionicPopup, shareSettings, $interval, $timeout) {
...
.run(function ($ionicPlatform, $rootScope, $state, $window, $ionicHistory, skipService, pauseService, connectToDeviceService) {
  ...
  $stateProvider.state('app', {
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/settings.html',
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/safety-slide.html',
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/program.html',
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/homing.html',
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/runBluetooth.html',
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/test.html',
        controller: 'testCtrl'
      }
    }
  }).state('app.website', {
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/website.html'
      }
    }
    ...
    views: {
      'menuContent': {
        templateUrl: '../www/templates/bluetoothConnection.html',
