...
/***/ function(module, exports, __webpack_require__) {
	...
	var _controllers = __webpack_require__(299);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _safetySlides = __webpack_require__(301);
	
	var _safetySlides2 = _interopRequireDefault(_safetySlides);
	
	var _programCtrl = __webpack_require__(302);
	
	var _programCtrl2 = _interopRequireDefault(_programCtrl);
	
	var _settingsCtrl = __webpack_require__(303);
	
	var _settingsCtrl2 = _interopRequireDefault(_settingsCtrl);
	
	var _runBluetoothCtrl = __webpack_require__(304);
	
	var _runBluetoothCtrl2 = _interopRequireDefault(_runBluetoothCtrl);
	
	var _homingCtrl = __webpack_require__(305);
	
	var _homingCtrl2 = _interopRequireDefault(_homingCtrl);
	
	var _bluetoothTestCtrl = __webpack_require__(306);
	
	var _bluetoothTestCtrl2 = _interopRequireDefault(_bluetoothTestCtrl);
	
	var _bluetoothConnectionCtrl = __webpack_require__(307);
	
	var _bluetoothConnectionCtrl2 = _interopRequireDefault(_bluetoothConnectionCtrl);
	
	var _errorController = __webpack_require__(308);
	...
	var _connectionStatusCtrl = __webpack_require__(310);
	
	var _connectionStatusCtrl2 = _interopRequireDefault(_connectionStatusCtrl);
	...
	.controller('SafetySlides', _safetySlides2.default).controller('ProgramController', _programCtrl2.default).controller('SettingsCtrl', _settingsCtrl2.default).controller('runBluetoothCtrl', _runBluetoothCtrl2.default).controller('homingCtrl', _homingCtrl2.default).controller('testCtrl', _bluetoothTestCtrl2.default).controller('bluetoothConnectionCtrl', _bluetoothConnectionCtrl2.default).controller('errorController', _errorController2.default).controller('connectionStatusCtrl', _connectionStatusCtrl2.default).controller('modalCtrl', _modalCtrl2.default);
...
/***/ function(module, exports) {
	...
	exports.default = function ($scope, $ionicModal, logService) {
	  $scope.i = 0;
...
/***/ function(module, exports) {
	...
	exports.default = function ($scope, $ionicModal, $ionicPopup, shareSettings, shareProgram, $state, logService, modalService) {
	  ...
	  $scope.loadUserPrograms = function () {
	    ...
	    //push the parsed userPrograms to $scope.userPrograms array
	        ...
	        for (var a = 0; a < window.localStorage.length; a++) {
	          if (window.localStorage.key(a) == 'Safety' || window.localStorage.key(a) == 'settings' || window.localStorage.key(a) == 'lastUsedProgram' || window.localStorage.key(a) == 'lastConnectedDevice') {} else {
	  ...
	  $scope.openLoadModal = function () {
	    modalService.init('load-modal.html').then(function (modal) {
	      modal.show();
	    });
	  };
	
	  $scope.openSaveModal = function () {
	    modalService.init('save-modal').then(function (modal) {
	      modal.show();
	    });
	  };
...
/***/ function(module, exports) {
	...
	exports.default = function ($rootScope, $scope, $ionicPopup, $state, shareSettings, logService, bugout) {
	  $scope.settings = {
	    encoder: {
	      enable: false,
	      stepsPerRPM: null,
...
/***/ function(module, exports) {
	...
	exports.default = function ($rootScope, $scope, $cordovaClipboard, $cordovaBluetoothSerial, $ionicPopup, $ionicModal, $state, $ionicPlatform, $window, $interval, $timeout, shareSettings, shareProgram, skipService, buttonService, emergencyService, bluetoothService, logService, calculateVarsService, sendAndReceiveService, statusService, logModalService, modalService, $async, errorService, bugout) {
	  ...
	  function cutsAndPins() {
	    ...
	    for (var i = 1; i <= program.numberOfCuts; i++) {
	      ...
	      var cutsRoundedUp = Math.ceil(program.cutWidth / program.sawWidth);
	      ...
	      if (i < program.numberOfCuts) {
	        ...
	        var pinSteps = (program.pinWidth + program.sawWidth) / $scope.settings.spindleAdvancement * $scope.settings.dipswitch;
	  ...
	  function checkWydone() {
	    ...
	    var wydoneEmergencyListener = $rootScope.$on('emergencyOn', function () {
	      $interval.cancel(timer);
	      bluetoothResponseListener();
	      wydoneListener();
	      wydoneEmergencyListener();
	    ...
	    var wydoneLeaveListener = $scope.$on('$ionicView.leave', function () {
	      $interval.cancel(timer);
	      bluetoothResponseListener();
	      wydoneListener();
	      wydoneEmergencyListener();
	  ...
	  function checkDone() {
	    ...
	    var checkdoneEmergencyListener = $rootScope.$on('emergencyOn', function () {
	      $interval.cancel(timer);
	      bluetoothResponseListener();
	      wydoneListener();
	      checkdoneEmergencyListener();
	    ...
	    var checkDoneLeaveListener = $scope.$on('$ionicView.leave', function () {
	      $interval.cancel(timer);
	      bluetoothResponseListener();
	      wydoneListener();
	      checkdoneEmergencyListener();
...
/***/ function(module, exports) {
	...
	exports.default = function ($rootScope, $scope, $cordovaClipboard, $cordovaBluetoothSerial, $ionicPopup, $ionicModal, $state, $ionicPlatform, $window, $interval, $timeout, shareSettings, shareProgram, skipService, buttonService, emergencyService, bluetoothService, logService, calculateVarsService, sendAndReceiveService, bugout, statusService, $ionicHistory, logModalService, modalService, $async, errorService) {
	  ...
	  function checkWydone() {
	    ...
	    var checkWydoneEmergencyListener = $rootScope.$on('emergencyOn', function () {
	      $interval.cancel(timer);
	      wydoneListener();
	      bluetoothResponseListener();
	      checkWydoneEmergencyListener();
	    ...
	    var checkWydoneLeaveListener = $scope.$on('$ionicView.leave', function () {
	      $interval.cancel(timer);
	      wydoneListener();
	      bluetoothResponseListener();
	      checkWydoneEmergencyListener();
...
/***/ function(module, exports) {
	...
	exports.default = function ($rootScope, $scope, $ionicPopup, $interval, $timeout, shareSettings, buttonService, emergencyService, bluetoothService, logService, calculateVarsService, sendAndReceiveService, statusService, modalService, $async, $state, bugout) {
	  ...
	  $scope.moveXMm = function () {
	    if (statusService.getEmergency() === false && statusService.getSending() === false && shareSettings.checkSettings()) {
	      if ($scope.numberOfTests.mm === undefined) {
	        ...
	        var commandIndex = commands.indexOf('<s0' + stepMotorNum + '>');
	  ...
	  function checkWydone(type) {
	    ...
	    var checkWydoneEmergencyLister = $rootScope.$on('emergencyOn', function () {
	      bluetoothResponseListener();
	      wydoneListener();
	      checkWydoneEmergencyLister();
	      checkWydoneLeaveListener();
	  ...
	  $scope.getVersion = $async(regeneratorRuntime.mark(function _callee5() {
	    var _this = this;
	              ...
	              return regeneratorRuntime.wrap(function _callee4$(_context4) {
	                while (1) {
	                  switch (_context4.prev = _context4.next) {
	                    case 0:
	                      versionListener = $rootScope.$on('bluetoothResponse', function (event, res) {
	                        if (res.search('<14:') > -1) {
	                          $ionicPopup.alert({
	                      ...
	                      _context4.next = 3;
	                      return sendAndReceiveService.sendWithRetry('<y8:y' + stepMotorNum + '>');
	
	                    case 3:
	                      _context4.next = 5;
	                      return sendAndReceiveService.sendWithRetry(softwareVersionCommand);
	...
	exports.default = function ($rootScope, $scope, $cordovaBluetoothSerial, $ionicPopup, $state, $ionicPlatform, $window, statusService, logService, buttonService, bluetoothService, $timeout, logModalService, modalService, errorService, $ionicLoading) {
	  ...
	  function connectToDevice(deviceID, deviceName) {
	    $ionicPlatform.ready(function () {
	      ...
	      showLoading();
	      bluetoothService.connectToSelectedDevice(deviceID, deviceName).then(function () {
	        addToLog('Your smartphone has succesfully connected with the selected Bluetooth device');
	        bluetoothService.getConnectedPromise().then(function (res) {
	          return $scope.isConnected = res;
	        });
...
/***/ function(module, exports) {
	...
	exports.default = function ($rootScope, $scope, modalService, logService, logModalService, $ionicPopup) {
	  var self = this;
...
/***/ function(module, exports) {
	...
	exports.default = function ($rootScope, $scope, bluetoothService) {
	  $scope.deviceName = bluetoothService.getDeviceName();
...
/***/ function(module, exports) {
	...
	function sendAndReceiveService(statusService, emergencyService, $window, logService, $rootScope, buttonService, crcService, shareSettings, $timeout, $async, bugout, bluetoothService, $interval) {
	  ...
	  $rootScope.$on("emergencyOn", function () {
	    ...
	    var connectionAvailable = $interval(function () {
	  ...
	  function responseListener(searchStr) {
	    return new Promise(function (resolve, reject) {
	      ...
	      //response received
	      var listener = $rootScope.$on('response', function (event, res) {
	        resReceived = true;
	        responseCount += 1;
	        var searchBool = checkResponse(res, searchStr);
	        if (searchBool) {
	  ...
	  sendAndReceive.sendWithRetry = $async(regeneratorRuntime.mark(function _callee2(str) {
	    var _this = this;
	  ...
	  sendAndReceive.writeAsync = $async(regeneratorRuntime.mark(function _callee4(str) {
	    var _this2 = this;
	        ...
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            ...
	            return _context4.delegateYield(regeneratorRuntime.mark(function _callee3() {
	              var expectedResponseShouldContain, resolveValue;
	              return regeneratorRuntime.wrap(function _callee3$(_context3) {
	                while (1) {
	                  switch (_context3.prev = _context3.next) {
	                    case 0:
...
/***/ function(module, exports) {
	...
	function shareSettings($ionicPopup, logService, $state) {
	  ...
	  function checkSettings(settings, skipAlert) {
	    var settingsToCheck = typeof settings === 'undefined' ? shareSettings.obj.settings : settings;
	    ...
	    else if (settingsToCheck.maxFreq !== null && settingsToCheck.dipswitch !== null && settingsToCheck.spindleAdvancement !== null && settingsToCheck.time !== null && settingsToCheck.stepMotorNum !== null && settingsToCheck.homingStopswitch !== null && settingsToCheck.encoder.enable === false) {
	        logService.consoleLog('checkSettings passed');
	        return true;
	      }
	      //  Pass the check with encoder enabled
	      else if (settingsToCheck.maxFreq !== null && settingsToCheck.dipswitch !== null && settingsToCheck.stepMotorNum !== null && settingsToCheck.spindleAdvancement !== null && settingsToCheck.time !== null && settingsToCheck.homingStopswitch !== null && settingsToCheck.encoder.enable === true && settingsToCheck.encoder.stepsPerRPM !== 0 && settingsToCheck.encoder.stepsToMiss > 0) {
	          logService.consoleLog('checkSettings passed');
	          return true;
	        } else {
	          logService.consoleLog('settings are not filled in correctly');
	...
	exports.default = function (bugout) {
	  ...
	  function setValues(obj) {
	    ...
	    for (var keyVal in obj) {
	      if (obj.hasOwnProperty(keyVal)) button.value[keyVal] = obj[keyVal];
	    }
	  }
...
/***/ function(module, exports) {
	...
	exports.default = function (buttonService, statusService, $rootScope, bugout) {
	  var emergency = this;
...
/***/ function(module, exports) {
	...
	function bluetoothService(bugout, $cordovaBluetoothSerial, window, logService, shareSettings, buttonService, $rootScope, $interval, $async, statusService, emergencyService) {
	  var self = this;
	  ...
	  function getBluetoothEnabledValue(cb, skipLog) {
	    $cordovaBluetoothSerial.isEnabled().then(function () {
	      ...
	      if (!skipLog) bugout.bugout.log('checkBluetoothEnabledService.value =' + bluetoothEnabled);
	  ...
	  self.connectWithRetry = $async(regeneratorRuntime.mark(function _callee3() {
	    var _this = this;
	        ...
	        switch (_context3.prev = _context3.next) {
	          case 0:
	            ...
	            return _context3.delegateYield(regeneratorRuntime.mark(function _callee2() {
	              var lastConnectedDevice, _loop, i, _ret2;
	                ...
	                while (1) {
	                  switch (_context2.prev = _context2.next) {
	                    ...
	                    case 22:
	                      _ret2 = _context2.t0;
	                      _context2.t1 = _ret2;
	                      _context2.next = _context2.t1 === 'break' ? 26 : 27;
	                      break;
...
/***/ function(module, exports) {
	...
	function logService(bugout, errorService) {
	  ...
	  function addOne(str, err) {
	    var errorLevel = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'critical';
...
/***/ function(module, exports) {
	...
	exports.default = calculateVarsService;
	function calculateVarsService(shareProgram, shareSettings) {
	  var vars = this;
	  //Available methods
	  ...
	  function getVars(type, cb) {
	    ...
	    if (type === 'homing') {
	      ...
	      vars.return.commands = ['<v' + vars.return.vars.direction + stepMotorNum + '>', '<p' + vars.return.vars.stepsPerRPM + stepMotorNum + '>', '<r' + vars.return.vars.maxRPM + stepMotorNum + '>', '<o' + vars.return.vars.time + stepMotorNum + '>', '<h' + vars.return.vars.homingStopswitchInt + stepMotorNum + '>', '<kFAULT' + stepMotorNum + '>'];
...
/***/ function(module, exports) {
	...
	exports.default = logModalService;
	function logModalService(bugout) {
	  var logModal = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function crcService() {
	  ...
	  crcService.appendCRC = function (str) {
	    ...
	    return str + String.fromCharCode(crc.Uint8High) + String.fromCharCode(crc.Uint8Low);
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function ($rootScope, bugout) {
	  var errors = [];
	  //example error: {level: 'critical', message: 'something went wrong'}
	  ...
	  this.addError = function (newErrorObj) {
	    var priorityMessage = false;
	    var priorityIndex = void 0;
	    errors.forEach(function (errObj, index) {
	      if (typeof errObj.message === 'undefined') {
	        console.log('UNDEFINED errObj.message:');
	        console.log(errObj);
	      }
	
	      if (errObj.message === 'Connection with bluetooth device lost' || errObj.message.search('has been hit. Aborting task.') > -1 || errObj.message === 'You have exceeded the maximum number of allowed steps') {
	    ...
	    if (!priorityMessage) {
	      ...
	      errors = _lodash2.default.flattenDeep([errors[0], newErrorObj, errors.slice(1)]);
	    }
	  ...
	  $rootScope.$on('emergencyOff', function () {
	    removeError(['Emergency is on', 'Emergency on, will not continue with movement', 'Error: Program reset command could not be sent.', 'has been hit. Aborting task.', 'You have exceeded the maximum number of allowed steps']);
	  });
	  ...
	  function removeError(msgArr) {
	    ...
	    errors = errors.filter(function (errObj) {
	      var remove = false;
